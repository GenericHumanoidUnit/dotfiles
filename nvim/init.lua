...
-- disable netrw, well be using nvim-tree
...
require('lazy').setup({
  ...
  -- change default nvim select ui to telescope
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript',
                       'vimdoc', 'vim', 'clojure', 'java', 'bash', 'yaml', 'terraform' },
...
-- add buffers to lualine tabline
